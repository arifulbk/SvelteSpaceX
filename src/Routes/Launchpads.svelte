...
<script>
    ...
    onMount(async () => {
        ...
        get_launchpads();
        console.log(JSON.stringify(launchpads));
...
<main>
    <div style="height:500px;" id="map-canvas" class="relative w-full rounded h-600-px container mx-auto " data-lat="40.748817" data-lng="-73.985428">
